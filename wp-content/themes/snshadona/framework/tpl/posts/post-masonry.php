	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	    ...
	    if ( get_post_format() == 'quote' && function_exists('rwmb_meta') && rwmb_meta('snshadona_post_quotecontent') && rwmb_meta('snshadona_post_quoteauthor') ) :
	        ...
	        <style scoped>
	            .quote-info-<?php echo $uq; ?>{
	                ...
	                font-size:  <?php echo esc_attr(rwmb_meta('snshadona_post_quote_size')); ?>;
	                font-weight:  <?php echo esc_attr(rwmb_meta('snshadona_post_quote_font_weight')); ?>;
	                <?php endif; ?>
	            }
	        </style>
	    <?php
	    ...
	    elseif ( has_post_thumbnail() ) : ?>
	        <div class="post-thumb">
	            ...
	            switch ($blog_type){
	            	case 'grid-2-col';
	            		$img_size = 'snshadona_blog_grid2_thumbnail_size';
	            		break;
	            	case 'grid-3-col';
	            		$img_size = 'snshadona_blog_grid3_thumbnail_size';
	            		break;
	            	case 'masonry';
	            		$img_size = 'full';
	            		break;
	        ...
	        <div class="content">
		        ...
		        <div class="post-meta">
			        ...
			        if (snshadona_themeoption('show_date', 1) == 1 && !is_sticky()) : ?>
			            <?php 
			            printf( '<span class="entry-date"><a href="%1$s" rel="bookmark"><time class="published" datetime="%1$s">%2$s</time></a></span>',
